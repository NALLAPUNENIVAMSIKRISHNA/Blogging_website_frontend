...
const Comments = ({ postId }) => {
    ...
    const fetchComments = async () => {
      try {
        const response = await axios.get(
          `https://blogging-website-backend-zxyi.onrender.com/api/comments/${postId}`
        );
  ...
  const handleCreateComment = async () => {
    ...
    try {
      const response = await axios.post(
        `https://blogging-website-backend-zxyi.onrender.com/api/comments`,
  ...
  const handleUpdateComment = async (id, updatedContent) => {
    ...
    try {
      const response = await axios.put(
        `https://blogging-website-backend-zxyi.onrender.com/api/comments/${id}`,
  ...
  const handleDeleteComment = async (id) => {
    try {
      await axios.delete(`https://blogging-website-backend-zxyi.onrender.com/api/comments/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
